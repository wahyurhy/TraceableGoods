...
internal class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        private const val SQL_CREATE_TABLE_PRODUK = "CREATE TABLE ${DatabaseContract.ProdukColumns.TABLE_NAME}" +
        ...
        private const val SQL_CREATE_TABLE_PRODUSEN = "CREATE TABLE ${DatabaseContract.ProdusenColumns.TABLE_NAME}" +
        ...
        private const val SQL_CREATE_TABLE_DISTRIBUTOR = "CREATE TABLE ${DatabaseContract.DistributorColumns.TABLE_NAME}" +
        ...
        private const val SQL_CREATE_TABLE_PENERIMA = "CREATE TABLE ${DatabaseContract.PenerimaColumns.TABLE_NAME}" +
        ...
        private const val SQL_CREATE_TABLE_PENGGILING = "CREATE TABLE ${DatabaseContract.PenggilingColumns.TABLE_NAME}" +
        ...
        private const val SQL_CREATE_TABLE_PENGEPUL = "CREATE TABLE ${DatabaseContract.PengepulColumns.TABLE_NAME}" +
        ...
        private const val SQL_CREATE_TABLE_GUDANG = "CREATE TABLE ${DatabaseContract.GudangColumns.TABLE_NAME}" +
        ...
        private const val SQL_CREATE_TABLE_TENGKULAK = "CREATE TABLE ${DatabaseContract.TengkulakColumns.TABLE_NAME}" +
        ...
        private const val SQL_CREATE_TABLE_PABRIK_PENGOLAHAN = "CREATE TABLE ${DatabaseContract.PabrikPengolahanColumns.TABLE_NAME}" +
        ...
        private const val SQL_CREATE_TABLE_TRANSAKSI = "CREATE TABLE ${DatabaseContract.TransaksiColumns.TABLE_NAME}" +
        ...
        private const val SQL_CREATE_TABLE_ALUR_DISTRIBUSI = "CREATE TABLE ${DatabaseContract.AlurDistribusiColumns.TABLE_NAME}" +
